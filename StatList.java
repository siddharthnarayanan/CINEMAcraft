...
public class StatList
{
    ...
    {
        objectUseStats = initUsableStats(objectUseStats, "stat.useItem", 16908288, 0, 4096);
        objectBreakStats = initBreakStats(objectBreakStats, "stat.breakItem", 16973824, 0, 4096);
    ...
    {
        objectUseStats = initUsableStats(objectUseStats, "stat.useItem", 16908288, 4096, 32000+4096);
        objectBreakStats = initBreakStats(objectBreakStats, "stat.breakItem", 16973824, 4096, 32000+4096);
    ...
    public static void initCraftableStats()
    {
        if (blockStatsInitialized && itemStatsInitialized)
        {
            ...
            objectCraftStats = new StatBase[32000+4096];
            var1 = var0.iterator();
    ...
    private static StatBase[] initUsableStats(StatBase[] par0ArrayOfStatBase, String par1Str, int par2, int par3, int par4)
    {
        ...
        {
            par0ArrayOfStatBase = new StatBase[32000+4096];
        }
