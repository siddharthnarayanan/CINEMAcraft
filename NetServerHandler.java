...
public class NetServerHandler extends NetHandler
{
    ...
    public void setPlayerLocation(double par1, double par3, double par5, float par7, float par8)
    {
        ...
        //System.out.println("This is the player location !!    "+ par1);
        Vars.kinectPosCounter = 10;
    }
    
    /*
     * Variant of the above without resetting PosCounter
     */
    public void setPlayerLocationWithoutReset(double par1, double par3, double par5, float par7, float par8)
    {
        this.hasMoved = false;
        this.lastPosX = par1;
        this.lastPosY = par3;
    ...
    public void handleChat(Packet3Chat par1Packet3Chat)
    {
        ...
        else
        {
            ...
            if (var2.length() > 500) // originally 100
            {
