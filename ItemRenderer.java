...
public class ItemRenderer
{
    ...
    public void renderItem(EntityLiving par1EntityLiving, ItemStack par2ItemStack, int par3)
    {
        ...
        {
        	//ICO: this is where the generic item blocks are being rendered
            this.mc.renderEngine.bindTexture("/terrain.png");
            this.renderBlocksInstance.renderBlockAsItem(Block.blocksList[par2ItemStack.itemID], par2ItemStack.getItemDamage(), 1.0F);
        }
        else
        {
        	//ICO: this is where other items like swords and armor are being rendered
        	//due to preexisting rotation it is really hard to place them here, we need to go further upstream
