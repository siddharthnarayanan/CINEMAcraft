...
/**
 * Creates the helmet for recording (ON)
 * @author Cody Cahoon
 * @version 2013.10.22
 */
public class BlockRed extends Block {
	 ...
	 */		
	protected BlockRed(int par1, Material par2Material){
	...
	public void registerIcons(IconRegister par1IconRegister) {
		this.front = par1IconRegister.registerIcon("redBlock");
		this.back = par1IconRegister.registerIcon("redBlock");
		this.top = par1IconRegister.registerIcon("redBlock");
		this.bottom = par1IconRegister.registerIcon("redBlock");
		this.left = par1IconRegister.registerIcon("redBlock");
		this.right = par1IconRegister.registerIcon("redBlock");
	}
}