...
public abstract class ServerConfigurationManager
{
    ...
    public void initializeConnectionToPlayer(INetworkManager par1INetworkManager, EntityPlayerMP par2EntityPlayerMP)
    {
        ...
        if ((Vars.isServer || Vars.isProjector || Vars.isCamera || Vars.isActor) && (!Vars.playerToRoles.containsKey(par2EntityPlayerMP.username) || Vars.playerToRoles.get(par2EntityPlayerMP.username).equals("spectator")))
    	{
    		new ChangeGameTypeThread(par2EntityPlayerMP.username).run();  	
    	}
    }
