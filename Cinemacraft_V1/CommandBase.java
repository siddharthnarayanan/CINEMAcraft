...
public abstract class CommandBase implements ICommand
{
    ...
    {
    	// System.out.println("<" + par0Str + "> <" + par1Str + ">");
    	if (par1Str != null)
    ...
    {
    	//System.out.println("+++" + par1ICommand.getCommandName() + " " + this.getCommandName() + this);
    	if (par1ICommand.getCommandName() == null || this.getCommandName() == null) return 1;
