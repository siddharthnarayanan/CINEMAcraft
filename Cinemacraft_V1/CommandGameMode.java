...
public class CommandGameMode extends CommandBase
{
    ...
    {
        //return !par2Str.equalsIgnoreCase(EnumGameType.SURVIVAL.getName()) && !par2Str.equalsIgnoreCase("s") ? (!par2Str.equalsIgnoreCase(EnumGameType.CREATIVE.getName()) && !par2Str.equalsIgnoreCase("c") ? (!par2Str.equalsIgnoreCase(EnumGameType.ADVENTURE.getName()) && !par2Str.equalsIgnoreCase("a") ? WorldSettings.getGameTypeById(parseIntBounded(par1ICommandSender, par2Str, 0, EnumGameType.values().length - 2)) : EnumGameType.CREATIVE/*ADVENTURE*/) : EnumGameType.CREATIVE) : EnumGameType.SURVIVAL;
        return !par2Str.equalsIgnoreCase(EnumGameType.SURVIVAL.getName()) && !par2Str.equalsIgnoreCase("s") ? (!par2Str.equalsIgnoreCase(EnumGameType.CREATIVE.getName()) && !par2Str.equalsIgnoreCase("c") ? WorldSettings.getGameTypeById(parseIntBounded(par1ICommandSender, par2Str, 1, EnumGameType.values().length - 4)) : EnumGameType.CREATIVE) : EnumGameType.CREATIVE; //2nd was EnumGameType.SURVIVAL
    }
