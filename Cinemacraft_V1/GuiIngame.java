...
public class GuiIngame extends Gui
{
    ...
    {
    	// failsafe in case a thePlayer is null
    	if (this == null || this.mc == null || this.mc.thePlayer == null)
    		return;
        ...
        if (this.mc.thePlayer.inventory != null)
        	var9 = this.mc.thePlayer.inventory.armorItemInSlot(3);
        ...
        // only projector and spectators following projector's view observe fade in/out
        if (Vars.isProjector || (Vars.isSpectator && Vars.followProjector == 2))
        {
	        if (Vars.fadeList[1])
	        {        
	         	this.renderFade(var6, var7);   
	        }
	        if (Vars.fadeList[2])
	        {        	
	         	this.renderFade(var6, var7); 
	        ...
	        if (Vars.fadeList[15])
	        {
	        	this.renderFadeBlack(var6, var7);
	        }
        }
        ...
        if (!this.mc.playerController.enableEverythingIsScrewedUpMode() && !Vars.projectorView)
        {        	
        ...
        // OPERACRAFT (this is obviously a wrong place, but how else do we know that the client has completely loaded?)
        if (!Vars.clientInit)
        {
        	Minecraft.getMinecraft().thePlayer.sendChatMessage(String.format("@status"));
        	Vars.clientInit = true;     	
        }
    }
   ...
   private void renderFade(int par1, int par2)
   {
	   GL11.glDisable(GL11.GL_DEPTH_TEST);
       GL11.glDepthMask(false);
       GL11.glBlendFunc(GL11.GL_SRC_ALPHA, GL11.GL_ONE_MINUS_SRC_ALPHA);
       GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
       GL11.glDisable(GL11.GL_ALPHA_TEST);
       this.mc.renderEngine.bindTexture("%blur%/misc/fade1blur.png");
       Tessellator var3 = Tessellator.instance;
       var3.startDrawingQuads();
       var3.addVertexWithUV(0.0D, (double)par2, -90.0D, 0.0D, 1.0D);
       var3.addVertexWithUV((double)par1, (double)par2, -90.0D, 1.0D, 1.0D);
   ...
   private void renderFadeBlack(int par1, int par2)
   {
	   GL11.glDisable(GL11.GL_DEPTH_TEST);
       GL11.glDepthMask(false);
       GL11.glBlendFunc(GL11.GL_SRC_ALPHA, GL11.GL_ONE_MINUS_SRC_ALPHA);
       GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
       GL11.glDisable(GL11.GL_ALPHA_TEST);
       this.mc.renderEngine.bindTexture("%blur%/misc/fadeBlack.png");
       Tessellator var3 = Tessellator.instance;
       var3.startDrawingQuads();
       var3.addVertexWithUV(0.0D, (double)par2, -90.0D, 0.0D, 1.0D);
       var3.addVertexWithUV((double)par1, (double)par2, -90.0D, 1.0D, 1.0D);
    ...
    public void updateTick()
    {
        ...
        if (this.mc.thePlayer != null)
        {
            ...
            if (var1 == null || Vars.projectorView)
            {
    ...
    {
    	if (Vars.isActor && !Vars.hideActorGUI)
        {
    		...
    		int armChoice = Vars.getOperaCraftPlayerArmState(Minecraft.getMinecraft().thePlayer.getEntityName());
    		if (armChoice == 0)
    		{
            	font.drawStringWithShadow("§e->", this.scaledWidth - 90, 30, 16777215);
            	font.drawStringWithShadow("U - Arms Up", this.scaledWidth - 75, 10, 16777215);
            	font.drawStringWithShadow("§eJ - Arms Down", this.scaledWidth - 75, 30, 16777215);
            	font.drawStringWithShadow("K - Left Out", this.scaledWidth - 75, 50, 16777215);
            	font.drawStringWithShadow("L - Right Out", this.scaledWidth - 75, 70, 16777215);
            	font.drawStringWithShadow("I - Left Angle", this.scaledWidth - 75, 90, 16777215);    
            	font.drawStringWithShadow("O - Right Angle", this.scaledWidth - 75, 110, 16777215);    	
    		}
    		else if (armChoice == 1)
    		{
            	font.drawStringWithShadow("§e->", this.scaledWidth - 90, 50, 16777215);
            	font.drawStringWithShadow("U - Arms Up", this.scaledWidth - 75, 10, 16777215);
            	font.drawStringWithShadow("J - Arms Down", this.scaledWidth - 75, 30, 16777215);
            	font.drawStringWithShadow("§eK - Left Out", this.scaledWidth - 75, 50, 16777215);
            	font.drawStringWithShadow("L - Right Out", this.scaledWidth - 75, 70, 16777215);
            	font.drawStringWithShadow("I - Left Angle", this.scaledWidth - 75, 90, 16777215);    
            	font.drawStringWithShadow("O - Right Angle", this.scaledWidth - 75, 110, 16777215);    	
    		}
    		...
    		{
            	font.drawStringWithShadow("§e->", this.scaledWidth - 90, 70, 16777215);
            	font.drawStringWithShadow("U - Arms Up", this.scaledWidth - 75, 10, 16777215);
            	font.drawStringWithShadow("J - Arms Down", this.scaledWidth - 75, 30, 16777215);
            	font.drawStringWithShadow("K - Left Out", this.scaledWidth - 75, 50, 16777215);
            	font.drawStringWithShadow("§eL - Right Out", this.scaledWidth - 75, 70, 16777215);
            	font.drawStringWithShadow("I - Left Angle", this.scaledWidth - 75, 90, 16777215);    
            	font.drawStringWithShadow("O - Right Angle", this.scaledWidth - 75, 110, 16777215);    	
    		}
    		else if (armChoice == 3)
    		{
            	font.drawStringWithShadow("§e->", this.scaledWidth - 90, 10, 16777215);
            	font.drawStringWithShadow("§eU - Arms Up", this.scaledWidth - 75, 10, 16777215);
            	font.drawStringWithShadow("J - Arms Down", this.scaledWidth - 75, 30, 16777215);
            	font.drawStringWithShadow("K - Left Out", this.scaledWidth - 75, 50, 16777215);
            	font.drawStringWithShadow("L - Right Out", this.scaledWidth - 75, 70, 16777215);
            	font.drawStringWithShadow("I - Left Angle", this.scaledWidth - 75, 90, 16777215);    
    		...
    		{
            	font.drawStringWithShadow("§e->", this.scaledWidth - 90, 90, 16777215);
            	font.drawStringWithShadow("U - Arms Up", this.scaledWidth - 75, 10, 16777215);
            	font.drawStringWithShadow("J - Arms Down", this.scaledWidth - 75, 30, 16777215);
            	font.drawStringWithShadow("K - Left Out", this.scaledWidth - 75, 50, 16777215);
            	font.drawStringWithShadow("L - Right Out", this.scaledWidth - 75, 70, 16777215);
            	font.drawStringWithShadow("§eI - Left Angle", this.scaledWidth - 75, 90, 16777215);    
            	font.drawStringWithShadow("O - Right Angle", this.scaledWidth - 75, 110, 16777215);    	
    		}
    		else if (armChoice == 5)
    		{
            	font.drawStringWithShadow("§e->", this.scaledWidth - 90, 110, 16777215);
            	font.drawStringWithShadow("U - Arms Up", this.scaledWidth - 75, 10, 16777215);
            	font.drawStringWithShadow("J - Arms Down", this.scaledWidth - 75, 30, 16777215);
            	font.drawStringWithShadow("K - Left Out", this.scaledWidth - 75, 50, 16777215);
            	font.drawStringWithShadow("L - Right Out", this.scaledWidth - 75, 70, 16777215);
            	font.drawStringWithShadow("I - Left Angle", this.scaledWidth - 75, 90, 16777215);    
            	font.drawStringWithShadow("§eO - Right Angle", this.scaledWidth - 75, 110, 16777215);    	
    		}    
    		else if (armChoice == 6)
    		{
            	font.drawStringWithShadow("U - Arms Up", this.scaledWidth - 75, 10, 16777215);
        	...
        	font.drawStringWithShadow("Y - Hide Help", this.scaledWidth - 75, this.scaledHeight - 32, 16777215);
        	
        }
        else if (Vars.isActor && Vars.hideActorGUI)
        {
        	//font.drawStringWithShadow("Y - Show Help", this.scaledWidth - 75, this.scaledHeight - 32, 16777215);   	
        }
        else if (Vars.isSpectator)
        {
        	font.drawStringWithShadow("Y - To Action", this.scaledWidth - 75, this.scaledHeight - 32, 16777215);
        	if (Vars.hideActorGUI)
        	{
	        	//System.out.println("Teleporting to " + Vars.projectorName);
	        	//issue teleport request via chat
    			Minecraft.getMinecraft().thePlayer.sendChatMessage(String.format("@tpspec %s", Vars.projectorName));
        		Vars.hideActorGUI = !Vars.hideActorGUI;
        	}
        	
        	font.drawStringWithShadow( "U - " + (Vars.followProjector == 2 ? "Freeroam" : "Cam View"), this.scaledWidth - 75, this.scaledHeight - 42, 16777215);
        	
        	// here we allow for spectators to use U key to toggle projector following instead of arm movement
			//System.out.println("GuiInGame U: " + Vars.isSpectator + " " + Minecraft.getMinecraft().thePlayer.getEntityName());
			if (Vars.followProjector == 1)
			{
				Vars.followProjector = 2;
				//System.out.println(Minecraft.getMinecraft().thePlayer.getEntityName() + " follow projector " + Vars.followProjector);
	        	//issue cam view request via chat
	    		Minecraft.getMinecraft().thePlayer.sendChatMessage(String.format("@tpspec %s %d", Vars.projectorName, Vars.followProjector));
			}
			else if (Vars.followProjector == 3)
			{
				Vars.followProjector = 0;
				//System.out.println(Minecraft.getMinecraft().thePlayer.getEntityName() + " STOP following projector " + Vars.followProjector);
				Minecraft.getMinecraft().thePlayer.sendChatMessage(String.format("@tpspec %s %d", Vars.projectorName, Vars.followProjector));
			}
        }
    	

    	// Kinect position teleportation (only servers and only if kinectPosition option is enabled)
    	/*if ((Vars.isServer && Vars.kinectPosition == 1) || (Vars.kinectPosition == 2 && Minecraft.getMinecraft().getIntegratedServer() != null)) 
    	{
    		//System.out.println("kinect position " + Vars.kinectPosCounter);
    		if (Vars.kinectPosCounter < 2)
    		{
    			for (OperaCraftPlayer player : Vars.players)
				{
					EntityPlayerMP plyr = Minecraft.getMinecraft().getIntegratedServer().getConfigurationManager().getPlayerForUsername(player.getUsername());
					if (plyr!= null)
					{
						if (Vars.kinectPosCounter == 1)
						{
							player.kinectLocX = plyr.posX;
							player.kinectLocY = plyr.posY;
							player.kinectLocZ = plyr.posZ;
							//System.out.println("Init pos " + player.getUsername() + " " + plyr.posX + " " + plyr.posY + " " + plyr.posZ);
							//TODO: do this when tp-ing and when going up or down
						}
						else
						{
							if (player.TorsoX != 0 || player.TorsoY != 0 || player.TorsoZ != 0)
							{
								double yawRadZ = plyr.rotationYaw * Math.PI / 180.0f;
								double yawRadX = (plyr.rotationYaw + 90) * Math.PI / 180.0f;
								//if ((plyr.posX != player.kinectLocX - player.TorsoX) || (plyr.posY != player.kinectLocY + player.TorsoY) || (plyr.posZ != player.kinectLocZ - player.TorsoZ))
								if (Vars.kinectMirror == 1)
								{
									if ((plyr.posX != player.kinectLocX + (Math.sin(yawRadZ)*player.TorsoZ - Math.sin(yawRadX)*player.TorsoX)) || (plyr.posY != player.kinectLocY + player.TorsoY) || (plyr.posZ != player.kinectLocZ - (Math.cos(yawRadZ)*player.TorsoZ - Math.cos(yawRadX)*player.TorsoX)))
									//if ((plyr.posX != player.kinectLocX + player.TorsoX) || (plyr.posY != player.kinectLocY + player.TorsoY) || (plyr.posZ != player.kinectLocZ + player.TorsoZ))
									{
	
										//System.out.println(plyr.posY + "=" + (player.kinectLocY + player.TorsoY));
										plyr.playerNetServerHandler.setPlayerLocationWithoutReset(player.kinectLocX + (Math.sin(yawRadZ)*player.TorsoZ - Math.sin(yawRadX)*player.TorsoX), player.kinectLocY + player.TorsoY, player.kinectLocZ - (Math.cos(yawRadZ)*player.TorsoZ - Math.cos(yawRadX)*player.TorsoX), plyr.rotationYaw, plyr.rotationPitch);
										//plyr.playerNetServerHandler.setPlayerLocationWithoutReset(player.kinectLocX + player.TorsoX, player.kinectLocY + player.TorsoY, player.kinectLocZ + player.TorsoZ, plyr.rotationYaw, plyr.rotationPitch);
									}
								}
								else
								{	
    	...
    	//KINECT NEW ENTRY POINT FOR TELEPORTING (FOR TESTING, WE WILL INTEGRATE THIS LATER INTO THE EXISTING ECOSYSTEM)
    	/*
    	EntityPlayerMP plyr = Minecraft.getMinecraft().getIntegratedServer().getConfigurationManager().getPlayerForUsername("ICAT01");
		if (plyr!= null)
		{
			String local;
	    	double kposx = 0, kposy = 0, kposz = 0;
	    	
	    	//if (message.contains("@ktorso"))
	    	local = message;
	    	
	    	//System.out.println("K: " + Vars.kinectLocX + " " + Vars.kinectLocY + " " + Vars.kinectLocZ);
	    	...
	    	if (message != null)
	    	{
		    	...
		    	kposx = Double.parseDouble(words[2]); 
		    	kposy = Double.parseDouble(words[3]); 
		    	kposz = Double.parseDouble(words[4]);
		    	message = null;
		    	 
		    	System.out.println("Kinect Teleport TODO XYZ " + kposx + " " + kposy + " " + kposz);
				
		    	//if (Vars.viewTimeDelta == 0)
		    	//	Vars.viewTimeDelta = Minecraft.getSystemTime();
		    	//if (Minecraft.getSystemTime() > Vars.viewTimeDelta + 500)
				//{//Vars.kinectLocX
		    		plyr.playerNetServerHandler.setPlayerLocation(Vars.kinectLocX - kposx, Vars.kinectLocY + kposy - 1.62, Vars.kinectLocZ - kposz, plyr.rotationYaw, plyr.rotationPitch);
		    		//System.out.println("Player rotation X:      " + plyr.rotationPitch + "             Player head Y:   " + plyr.rotationYaw);
		    		//plyr.playerNetServerHandler.setPlayerLocation(Vars.kinectLocX - kposx, Vars.kinectLocY + kposy - 1.62, Vars.kinectLocZ - kposz, ModelBiped.rotationYaw, ModelBiped.rotationPitch);
		    		//System.out.println("Player Position:   " + plyr.posX + "     " + plyr.posY + "       " + plyr.posZ);
		    		//Vars.viewTimeDelta = Minecraft.getSystemTime();
				//}
	    	}
			//plyr.playerNetServerHandler.setPlayerLocation(plyr.posX, plyr.posY, plyr.posZ, plyr.rotationYaw, plyr.rotationPitch);
		...
		*/
        ...
        if (Vars.isServer && Vars.cameraViewPortValue != 0 && Vars.commandSenderServer != null  && Vars.viewTimeDelta < (Minecraft.getSystemTime() - 500)) // removed && Vars.getCameraByName(par7Entity.getEntityName()) == Vars.cameraViewPortValue
        {
        	...
        	if (!Vars.projectorName.equals(""))
    		{
	    		...
	    		{
	    			//System.out.println("!!!");
	    			//KINECTODO here's the command to teleport person around, implement here
	    			...
	    			String local;
	    	    	double kposx =camera.posX, kposy = camera.posY, kposz =camera.posZ;
	    	    	...
	    	    	if (message != null)
	    	    	{
	    	    		//System.out.println("The torso message has been received       " + message) ;
		    	    	String[] words = message.split(" ");
		    	    	kposx = Double.parseDouble(words[2]); 
		    	    	kposy = Double.parseDouble(words[3]); 
		    	    	kposz = Double.parseDouble(words[4]); 
		    	    	 
		    	    	//System.out.println("kposx       " +kposx);
		    	     	//System.out.println("kposy       " +kposy);
		    	     	//System.out.println("kposz       " +kposz);
		    	     	
		    	     	//System.out.println("--------------------------------");
	    	     	}
	    	    	else {
	    	    		kposx =camera.posX; kposy =camera.posY; kposz =camera.posZ; 
	    	    	}
	    			
	    			projector.playerNetServerHandler.setPlayerLocation(kposx, kposy, kposz, camera.rotationYaw, camera.rotationPitch);
	    			//System.out.println("This is the player location !!    "+camera.posX);
	    		}    
    		}
		}
        ...
        if (Vars.isServer && Vars.spectatorsFollowingProjector.size() > 0) // we check if we have any spectator followers
        {
        	if (!Vars.projectorName.equals(""))
        	{
        		...
        		for (int i = 0; i < Vars.spectatorsFollowingProjector.size(); i++) {
    	    		...
    	    		{    			
    	    			...
    	    			//System.out.println("This is the player location !!    "+projector.posX);
    	    		}
        		}
        	}
        }
    ...
    {
        if ((Vars.isActor || Vars.isSpectator || Vars.isCamera) && !Vars.projectorView)
        {
        	//font.drawStringWithShadow("H - Hide Gui", this.scaledWidth - 75, this.scaledHeight - 22, 16777215); 
        }
        else if ((Vars.isActor || Vars.isSpectator || Vars.isCamera) && Vars.projectorView)
        {
        	//font.drawStringWithShadow("H - Show Gui", this.scaledWidth - 75, this.scaledHeight - 22, 16777215);   	
        }
    }    
    
    public void handleName()
    {
    	String playersName = Minecraft.getMinecraft().thePlayer.getEntityName();
    	//System.out.println("handleName: " + playersName + " containsKey=" + Vars.playerToNickName.containsKey(playersName) + " isProjector=" + Vars.isProjector + " isCamera=" + Vars.isCamera + " isActor=" + Vars.isActor + " isSpectator=" + Vars.isSpectator);
    	if (Vars.playerToNickName.containsKey(playersName) && !Vars.isProjector && !Vars.isCamera && Vars.isActor)
    	{
    		/*if (Vars.playerToColors.containsKey(playersName))
    			font.drawStringWithShadow(Vars.colorCodes.get(Vars.playerToColors.get(playersName)) + Vars.playerToNickName.get(playersName), this.scaledWidth - 75, this.scaledHeight - 12, 16777215); 
    		else
    			font.drawStringWithShadow(Vars.playerToNickName.get(playersName), this.scaledWidth - 75, this.scaledHeight - 12, 16777215); */

    	}
    	else if (Vars.isServer)
    	{
    		font.drawStringWithShadow("SERVER", this.scaledWidth - 40, this.scaledHeight - 12, 16777215);
    	}
    	else if (Vars.isCamera)
    	{
    		if (Vars.cameraReverseValues.containsKey(playersName))
    		{
    			font.drawStringWithShadow("Camera - " + Vars.cameraReverseValues.get(playersName), this.scaledWidth - 75, this.scaledHeight - 12, 16777215);
    			if (Vars.currentCamera.equals(playersName))
    			{
        			font.drawStringWithShadow("  §cACTIVE", this.scaledWidth - 75, this.scaledHeight - 32, 16777215);    				
    			}
    		}
    		else
    		{
    			font.drawStringWithShadow("Camera", this.scaledWidth - 75, this.scaledHeight - 12, 16777215); 
    		}
    	}
    	else if (Vars.isSpectator || (playersName != null && !Vars.playerToRoles.containsKey(playersName)))
    	{
			font.drawStringWithShadow("Spectator", this.scaledWidth - 75, this.scaledHeight - 12, 16777215); 
    	}
    }
}
