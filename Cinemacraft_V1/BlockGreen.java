...
public class BlockGreen extends Block {
	 ...
	 */		
	protected BlockGreen(int par1, Material par2Material){
	...
	public void registerIcons(IconRegister par1IconRegister) {
		this.front = par1IconRegister.registerIcon("greenBlock");
		this.back = par1IconRegister.registerIcon("greenBlock");
		this.top = par1IconRegister.registerIcon("greenBlock");
		this.bottom = par1IconRegister.registerIcon("greenBlock");
		this.left = par1IconRegister.registerIcon("greenBlock");
		this.right = par1IconRegister.registerIcon("greenBlock");
	}
}