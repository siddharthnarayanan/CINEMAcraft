...
public class EntityPlayerSP extends EntityPlayer
{
    ...
    public float lastRotationYaw = 0;
    ...
    public void onLivingUpdate()
    {
        ...
        else
        {
            ...
            {
            	// get rid of the inventory achievement reminder
            ...
            boolean ret = this.movementInput.updatePlayerMoveState();
            if (ret == true || this.isJumping || this.isSneaking() || this.lastRotationYaw != this.rotationYaw) // we get true if this person has pressed one of the keys, which should not happen for NPCs
            {
				Vars.kinectPosCounter = 10;
				this.lastRotationYaw = this.rotationYaw;
				//System.out.println("Init player " + Vars.kinectLocX + " " + Vars.kinectLocY + " " + Vars.kinectLocZ);

            }
    		if (Vars.kinectPosCounter > 0)
    		{
    			if (Vars.kinectPosCounter == 1)
    			{
    				if (Minecraft.getMinecraft().getIntegratedServer()!= null && !Vars.portOpen)
    				{
    					System.out.println("Opening default port 7000...");
    					Minecraft.getMinecraft().getIntegratedServer().executeCommand("openport");
    					Vars.portOpen = true;
    				}
    			}
    			Vars.kinectPosCounter--;
    		}
            //System.out.println("rotationYaw=" + this.rotationYaw + "LastrotationYaw=" + this.lastRotationYaw + " KposCounter=" + Vars.kinectPosCounter);
