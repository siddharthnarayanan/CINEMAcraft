...
public class Item
{
    ...
    public static Item[] itemsList = new Item[32000 + 4096];
    ...
    protected Item(int par1)
    {
        ...
        this.itemID = 4096 + par1;

        if (itemsList[4096 + par1] != null)
        {
            System.out.println("CONFLICT @ " + par1);
        }

        itemsList[4096 + par1] = this;
    }

    public Item setMaxStackSize(int par1)
    {
    	//System.out.println("MaxStackSize:"+par1);
