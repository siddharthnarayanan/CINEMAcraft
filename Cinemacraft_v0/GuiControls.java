...
public class GuiControls extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        for (int var3 = 0; var3 < this.options.keyBindings.length - 8; ++var3) // we make OPERAcraft buttons not customizable
        {
        	//if (!this.options.getOptionDisplayString(var3).equals("Y") && !this.options.getOptionDisplayString(var3).equals("H"))
        	//this.buttonList.add(new GuiSmallButton(var3, var2 + var3 % 2 * 160, 10 + this.height / 12 + 16 * (var3 >> 1) , 70, 16, this.options.getOptionDisplayString(var3)));
    ...
    {
        for (int var2 = 0; var2 < this.options.keyBindings.length - 8; ++var2)  // we make OPERAcraft buttons not customizable
        {
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        while (var5 < this.options.keyBindings.length - 8)  // we make OPERAcraft buttons not customizable
        {
            boolean var6 = false;
            int var7 = 0;
            ...
            while (true)
            {
                if (var7 < this.options.keyBindings.length - 8)  // we make OPERAcraft buttons not customizable
                {
                ...
                //this.drawString(this.fontRenderer, this.options.getKeyBindingDescription(var5), var4 + var5 % 2 * 160 + 70 + 6, 8 + this.height / 12 + 16 * (var5 >> 1) + 7, -1);
