...
public class InventoryPlayer implements IInventory
{
    ...
    {    	
        if (par1ItemStack == null || (Vars.playerToRoles.containsKey(player.getEntityName()) && !Vars.playerToRoles.get(player.getEntityName()).equals("actor"))) // Vars check prevents players from picking up things except for actors
        {
            return false;
        }
        else
