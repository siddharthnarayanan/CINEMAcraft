...
public class GuiMainMenu extends GuiScreen
{
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        if (!Vars.splash)
        {
	        ...
	        {
	        	case 0:
	        		this.splashText = "Virginia Tech!";
	        		break;
	        	case 1:
	        		this.splashText = "opppppppppeeeeeerrraaaaaa";
	        		break;        		
	        	default:
	        		this.splashText = "Go Hokies!";
	        		break;        
	        }
	        Vars.splash = true;
	        //Vars.playersName = this.mc.session.username;
	        new OnOpenUpdate(this.mc.session.username).run();
        }
        this.drawCenteredString(this.fontRenderer, this.splashText, 0, -8, 16776960);
        GL11.glPopMatrix();
        String var9 = "Minecraft 1.5.2/OPERAcraft " + Vars.version;
